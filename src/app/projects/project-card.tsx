...
export const ProjectCard = ({ project }: ProjectProps) => {
  return (
    <div className="flex w-full flex-col justify-between rounded-lg border border-gray-400 bg-white p-4 leading-normal shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md">
